...
> (domain PPL +6.6%) สาเหตุน่าจะเป็น `learning_rate` สูงเกินไป **และ** คลังข้อมูล 130MB ที่ใช้เทรนกลับกลาย
> เป็น Wikipedia ทั่วไปที่ไม่เกี่ยวกับโดเมนเลย >99% (เต่า, David Bowie, หนัง, วิดีโอเกม ฯลฯ)
> รายละเอียดเต็มอยู่ที่ [RESULTS.md §11](RESULTS.md#11-รันเต็มสเกล-outputs_large_v2--29-กค1-สค-2026--ผลลบ)
> และ [§12](RESULTS.md#12-เตรียม-v3--แก้-data-source--config-ตามแผนใน-11-1-สค-2026--ยังไม่ได้รัน)
> **อย่าเพิ่งใช้โมเดลนี้งานจริง**
>
> **🟡 แก้ไขแล้ว รอรันรอบถัดไป (v3):** สร้างคลังข้อมูลใหม่ทั้งหมด (606 เอกสารที่เกี่ยวข้องจริง แทน 8,127
> เอกสารเดิมที่ส่วนใหญ่เป็นขยะ) ปรับ `learning_rate`/`lora_r`/`epochs` ใหม่ตามบทเรียนจากรอบที่แล้ว —
> `configs/cpt_large_v3.yaml` พร้อมรันแล้ว แต่**ยังไม่ได้เริ่มเทรน**
>
